                        ...
                        <ul className="w-full h-full">
                            {
                                props.options.map((option) => (
                                    <li
                                        key={option.key}
                                        onClick={() => option.onClickCallback()}
                                        className="w-full text-start flex items-center font-semibold first-letter:uppercase cursor-default text-sm max-h-12 justify-start px-4 py-2 hover:rounded-sm  hover:border-[#7b64e2] hover:text-[#7b64e2] hover:bg-[#110642] my-1 text-white">
                                        {option.title}
                                    </li>
                                ))
                            }
